...
- **Constrain the output** — [[acceptance-test-bdd|acceptance tests]] from one side, design decisions from the other, then <span style="color:red">the [[static-analysis-gauntlet]] (machines draw blood first) and</span> [[multi-model-review]]<span style="color:red"> / [[code-review]] (sorted, judgement-only) where the human spends a fading attention budget</span>.
