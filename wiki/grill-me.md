...
<span style="color:red">## Four lines are a declaration of war
...
End every grill with the same instruction: **"summarize the Q&A into a [[handover]]"** — which is exactly the input to [[spec-driven-development]] (paste it into [[openspec]]). And keep tone calm: insulting the agent triggers [[sycophancy]] and it loses impartiality (see "don't insult the AI").</span>
