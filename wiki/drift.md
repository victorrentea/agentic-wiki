...
- <span style="color:red">**[[archunit-drift-control]]** for *static* structure — ArchUnit unit-tests package dependencies, and the class diagram is reflected out of the compiled code at test time, so a stale `.puml` fails the build. (AI-generated diagrams drift the moment they're written.)</span>
