...
category: security
tags: [security, jailbreak, adversarial, system-prompt, guardrails]
...
The [[system-prompt]] alone is a "pretty-please constraint" — necessary but not sufficient. Layer it with [[guardrails]]: regex/keyword pre-filters, then a [[judge-llm]] that evaluates both prompt and response before any reply reaches the user. For [[tool-calling]], validate every model-authored parameter as untrusted input.
